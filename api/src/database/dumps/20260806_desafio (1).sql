...
CREATE TABLE desafio.sala (
    ...
    variacao_capacidade smallint default 2 NULL,
    ativo boolean DEFAULT true,
    criado_em timestamp(6) without time zone DEFAULT CURRENT_TIMESTAMP
);
...
SELECT pg_catalog.setval('desafio.acesso_id_seq', 1, false);

SELECT pg_catalog.setval('desafio.agendamento_id_seq', 1, false);

SELECT pg_catalog.setval('desafio.feriado_id_seq', 1, false);

SELECT pg_catalog.setval('desafio.sala_id_seq', 1, false);

SELECT pg_catalog.setval('desafio.sala_responsavel_id_seq', 1, false);

SELECT pg_catalog.setval('desafio.tipo_prioridade_id_seq', 1, false);

SELECT pg_catalog.setval('desafio.visitante_id_seq', 1, false);
...
ALTER TABLE ONLY desafio.feriado
    ADD CONSTRAINT feriado_pkey PRIMARY KEY (id);

ALTER TABLE ONLY desafio.sala
    ADD CONSTRAINT sala_pkey PRIMARY KEY (id);

ALTER TABLE ONLY desafio.sala_responsavel
    ADD CONSTRAINT sala_responsavel_pkey PRIMARY KEY (id);

ALTER TABLE ONLY desafio.tipo_prioridade
    ADD CONSTRAINT tipo_prioridade_pkey PRIMARY KEY (id);
